<% breadcrumbsline %>
<section class="news" itemscope itemtype="https://schema.org/NewsArticle" rel="nofollow">
	...
	<article itemprop="articleBody">
		...
		<?php else:?>
			<div class="img-invisible">
				<img src="/img/content/no-image.jpg" alt="<?=Elf::$_data['picture_alt']?Elf::$_data['picture_alt']:Elf::$_data['title']?>" />
			</div>
		<?php endif;?>
	...
	<div itemprop="image" itemscope itemtype="https://schema.org/ImageObject" rel="nofollow">
		<span itemprop="url" content="<?=Elf::$_data['picture']?Elf::$_data['picture_image']:'/img/content/no-image.jpg'?>"></span> 
		<span itemprop="image" content="<?=Elf::$_data['picture']?Elf::$_data['picture_image']:'/img/content/no-image.jpg'?>"></span>
	...
	<div itemprop="publisher" rel="nofollow" itemscope itemtype="https://schema.org/Organization">
		<div itemprop="logo" rel="nofollow" itemscope itemtype="https://schema.org/ImageObject">
			<img itemprop="url image" src="/img/design/logo-smpl.png" style="display:none;" alt="<% lang:og:imagelogo.tlt %>" />
